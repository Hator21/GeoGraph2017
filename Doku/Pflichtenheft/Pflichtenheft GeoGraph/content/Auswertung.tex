\newpage
	...
	\begin{itemize}
		...
		\item Das System muss erweiterbar sein. Das heißt ......
	\end{itemize}
	...
	\begin{table}[H]
		\begin{tabular}{|p{8cm}|p{8cm}|}
			...
			2. User befindet sich im Reiter "Mittelpunkt" \newline
			3. User hat Breitengrad und Längengrad eingegeben	\\ \hline 
			...
			1. User gibt Breitengrad und Längengrad ein \newline
	...
	\begin{table}[H]
		\begin{tabular}{|p{8cm}|p{8cm}|}
			...
			\textbf{Other Use Cases :}\centering & - \\ \hline  
			\textbf{Main Success Scenario :}\centering & 
			1. User gibt Boundingbox (Längengrad min/max und Breitengrad min/max) ein \newline
			2. User klickt auf "Nach Kordinaten suchen" \newline
			3. GEO-06 \\ \hline  
			\textbf{Extensions :}\centering & - \\ \hline  
			\textbf{Priority :}\centering & High \\ \hline  
	...
	\begin{table}[H]
		\begin{tabular}{|p{8cm}|p{8cm}|}
			...
			\textbf{Primary Actor :} \centering & User \\ \hline 
			\textbf{Preconditions :}\centering & User befindet sich im Reiter "Mittelpunkt" \\ \hline 
			\textbf{Postconditions :}\centering	& 
	...
	\begin{table}[H]
		\begin{tabular}{|p{8cm}|p{8cm}|}
			...
			\textbf{ID :}\centering & GEO-06  \\ \hline 
			\textbf{Title :}\centering & Karte zeichnen \\ \hline 
			\textbf{Description :}\centering & Karte zeichen nach Eingabe von Boundingbox min/max \\ \hline 
