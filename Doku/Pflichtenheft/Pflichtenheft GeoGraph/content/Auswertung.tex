...
\newpage
	...
	\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{images/Mittelpunkt}
	\caption{Benutzeroberfläche Mittelpunkt Tab}
	\label{fig:GUI}
	\end{figure}

	\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{images/Bereich}
	\caption{Benutzeroberfläche Bereich Tab}
	\label{fig:GUI}
	\end{figure}

	\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\linewidth]{images/Datei}
	\caption{Benutzeroberfläche Datei Tab}
	\label{fig:GUI}
	\end{figure}
